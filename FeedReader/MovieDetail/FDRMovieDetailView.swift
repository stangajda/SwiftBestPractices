        ...
        ScrollView {
            VStack(alignment: .leading){
                Text(viewModel.movieList.title)
                    ...
                    .lineLimit(1)
                    .padding()
                FDRImageView(viewModel: Resolver.resolve(name:.itemDetail,args:["imageURL": movieDetail.backdrop_path,"imageSizePath": FDROriginalPath() as FDRImagePathProtocol,"cache": cache as Any]))
